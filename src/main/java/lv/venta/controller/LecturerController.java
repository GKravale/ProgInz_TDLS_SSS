...
public class LecturerController {
	...
	public String getAllLecturers(Model model) {
		try {
			model.addAttribute("package", lecturerService.getAllLecturers());
	...
	public String getLecturerRemove(@PathVariable("lid") int lId, Model model) {
		try {
			...
			ArrayList<Lecturer> allLecturers = (ArrayList<Lecturer>) lecturerService.getAllLecturers();
	...
	public String getLecturerUpdate(@PathVariable("lid") int lId, Model model) {
		try {
			...
			Optional<Lecturer> lecturerForUpdating = lecturerService.getLecturerById(lId);
	...
	public String postLecturerUpdate(@PathVariable("lid") int lId, @Valid Lecturer lecturer, BindingResult result,
			Model model) {
		try {
